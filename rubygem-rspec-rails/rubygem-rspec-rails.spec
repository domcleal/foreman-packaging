...
Requires: %{?scl_prefix_ror}rubygem(activesupport) < 4
Requires: %{?scl_prefix_ror}rubygem(actionpack) => 3.0
Requires: %{?scl_prefix_ror}rubygem(actionpack) < 4
Requires: %{?scl_prefix_ror}rubygem(railties) => 3.0
Requires: %{?scl_prefix_ror}rubygem(railties) < 4
Requires: %{?scl_prefix_ror}rubygem(rspec) => 2.11.0
Requires: %{?scl_prefix_ror}rubygem(rspec) < 2.12
BuildRequires: %{?scl_prefix_ruby}rubygems-devel
BuildRequires: %{?scl_prefix_ruby}ruby(release)
%if 0%{enable_test} > 0
BuildRequires: %{?scl_prefix_ror}rubygem(rspec) => 2.11.0
BuildRequires: %{?scl_prefix_ror}rubygem(rspec) < 2.12
BuildRequires: %{?scl_prefix_ror}rubygem(rails) => 3.0
BuildRequires: %{?scl_prefix_ror}rubygem(rails) < 4
...
BuildRequires: %{?scl_prefix_ror}rubygem(ZenTest)
