...
Requires: %{?scl_prefix}rubygem(activerecord-session_store) >= 0.1
Requires: %{?scl_prefix}rubygem(activerecord-session_store) < 1.0
...
BuildRequires: %{?scl_prefix}rubygem(i18n) >= 0.7
...
BuildRequires: %{?scl_prefix}rubygem(activerecord-session_store) >= 0.1
BuildRequires: %{?scl_prefix}rubygem(activerecord-session_store) < 1.0
